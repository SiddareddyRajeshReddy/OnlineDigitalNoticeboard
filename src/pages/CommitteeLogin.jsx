...
const CommitteeLogin = ({ setUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await committeeAPI.login(form);
      ...
      <main className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="committee@nitsikkim.ac.in"
              />
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/committee/signup" className="text-red-700 hover:underline">
              Register here
            </Link>
          </p>
        </div>
